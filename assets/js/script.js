var apiKey = "9080dfa499c180e2798098f2ecbde02e";
...
function currentCondition(city) {
    ...
    $.ajax({
        ...
        $.ajax({
            ...
            $("#currentWeather").append(uvIndexP);
...
$("#searchBtn").on("click", function(event) {
    ...
    if (!searchResultsList.includes(city)) {
        searchResultsList.push(city);
        var searchedCity = $(`
            <li class="list-group-item">${city}</li>
            `);
        $("#searchResults").append(searchedCity);
    };
    
    localStorage.setItem("city", JSON.stringify(searchResultsList));
